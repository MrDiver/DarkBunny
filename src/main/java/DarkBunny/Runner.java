...
import DarkBunny.util.PortReader;
...
public class Runner {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Starting a Dark Era");
        ...
        dataPanel.add(new JLabel("Hearing dark voices on port " + port), BorderLayout.CENTER);
        dataPanel.add(new JLabel("I'm controlling the darkness keep me open!"), BorderLayout.CENTER);
        JLabel botsRunning = new JLabel("Minions running: ");
        dataPanel.add(botsRunning, BorderLayout.CENTER);
        panel.add(dataPanel, BorderLayout.CENTER);
        frame.add(panel);

        URL url = Runner.class.getClassLoader().getResource("icon.png");
